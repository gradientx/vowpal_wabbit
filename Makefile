...
ACLOCAL = ${SHELL} /Users/dgoya/git/vowpal_wabbit/missing --run aclocal-1.12
AMTAR = $${TAR-tar}
AR = ar
AUTOCONF = ${SHELL} /Users/dgoya/git/vowpal_wabbit/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/dgoya/git/vowpal_wabbit/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/dgoya/git/vowpal_wabbit/missing --run automake-1.12
AWK = awk
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/dgoya/git/vowpal_wabbit/missing --run makeinfo
MANIFEST_TOOL = :
