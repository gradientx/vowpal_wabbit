...
#include "com_gradientx_vw_VwJniBinding.h"
using namespace std;
 
/* global VW instance */
#define VW_NUM com_gradientx_vw_VwJniBinding_VW_NUM
vw vw_arr[VW_NUM];

JNIEXPORT void JNICALL Java_com_gradientx_vw_VwJniBinding_initialize(JNIEnv *env, jobject, jint id, jstring initStr)
{
  char *str;
...
JNIEXPORT jfloat JNICALL Java_com_gradientx_vw_VwJniBinding_read_1example(JNIEnv *env, jobject, jint id, jstring exStr)
{
  char *str;
...
JNIEXPORT void JNICALL Java_com_gradientx_vw_VwJniBinding_finish(JNIEnv *, jobject, jint id)
{
  VW::finish(vw_arr[id]);
}

JNIEXPORT jfloatArray JNICALL Java_com_gradientx_vw_VwJniBinding_get_1coef(JNIEnv *env, jobject, jint id, jint size, jint constIdx)
{
  jfloatArray result;
